...
基础字段（`message`, `type`, `code`, `param`）始终存在。提示字段（`did_you_mean`, `suggestions`, `hint`, `retryable`, `retry_after`, `balance_usd`, `estimated_cost_usd`）是用于 AI agent 自我纠正的可选扩展。详情见 [Agent-First API guide](/guides/agent-first-api)。
