...
AI Sonar 原生接入可以继续使用 snake_case 的 `/v1/videos/assets*` REST 接口。已有火山客户端可以保留 PascalCase 请求体并使用[火山兼容素材 Action](/zh/api-reference/video/volc-compatible-material-actions)。两套接口操作同一份组织和项目范围内的素材数据。
