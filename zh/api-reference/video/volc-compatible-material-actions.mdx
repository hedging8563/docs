...
这些 Action 允许现有火山素材客户端保留 Action 名称、`Version=2024-01-01`、PascalCase JSON、筛选、排序、分页以及 `ResponseMetadata + Result` 信封。AI Sonar 只替换接口地址和鉴权方式。
...
AI Sonar 的 `/v1/videos/assets*` REST 接口继续可用。新接入可选择 snake_case REST；已有火山客户端无需改造请求体。 [Seedance 素材与真人验证](/zh/guides/seedance-materials).
