...
description: "创建一个 Seedance 虚拟数字人素材组。"
---

创建一个 `library_type: "aigc_avatar"` 的素材组。请使用此端点创建虚拟数字人、产品、风格以及其他无需真人验证的可复用参考素材。

新的真人素材组需通过 [真人素材验证](/zh/api-reference/video/create-real-person-verification-session) 创建，无法直接通过此端点创建。
