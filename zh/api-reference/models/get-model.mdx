...
<ResponseField name="aisonar" type="object">
  AI Sonar 专属的公开元数据。详情路由可包含 `category`、`pricing_unit`、`capability_flags`、`supported_operations`、`pricing_provenance`、`request_format_summary`、完整的 `request_format_details`，以及非聊天推荐快照的场景级 `agent_preferences`。
</ResponseField>
