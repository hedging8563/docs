...
3D generation is asynchronous. `POST /v1/3d/generations` creates an AI Sonar task; completed status responses return downloadable model assets such as `model_url` and, when available, format-specific URLs.
