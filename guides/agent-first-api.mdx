...
```json
{
  "error": {
    ...
    "hint": "Insufficient balance: need ~$0.3500 for claude-sonnet-4-6, but balance is $0.1200. Try a cheaper model, or top up at https://console.aisonar.dev/customer/billing."
  }
}
```
