...
Do not include API keys, private media, full prompts, provider URLs, channel IDs, or private diagnostic identifiers unless AI Sonar support explicitly asks for a redacted sample.
