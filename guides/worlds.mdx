...
Create responses include a public task ID and usually a poll_url. Store that ID before showing progress, then follow poll_url or GET /v1/tasks/{id} until the task reaches completed or failed.
