...
For new OpenAI-style integrations, prefer **Responses streaming** first. If your framework still uses Chat Completions streaming, AI Sonar supports that compatibility path too.
