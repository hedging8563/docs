...
<ParamField body="contents" type="array" required>
  ...
  For media parts, AI Sonar currently accepts image, audio, and video MIME types and forwards them through the Gemini-compatible model details.
