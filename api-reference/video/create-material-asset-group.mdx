...
New real-person material groups are created through [real-person material verification](/api-reference/video/create-real-person-verification-session) and cannot be created directly with this endpoint.
