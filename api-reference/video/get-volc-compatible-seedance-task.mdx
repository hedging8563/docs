...
The response never adds AI Sonar fields such as `progress`, `return_last_frame`, `watermark`, `priority`, or `camera_fixed`.

## Example

```bash
curl https://api.aisonar.dev/api/v3/contents/generations/tasks/cgt-0123456789abcdef0123456789abcdef \
