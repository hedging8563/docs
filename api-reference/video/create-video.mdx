...
<ParamField body="material_asset_id" type="string">
  AI Sonar Seedance material asset ID returned by [Create Material Asset](/api-reference/video/create-material-asset) or automatic image preparation. Use it after the asset is `ACTIVE` with Seedance models that can use the AI Sonar material library.
</ParamField>
