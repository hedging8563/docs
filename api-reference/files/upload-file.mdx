...
<ResponseField name="purpose" type="string">Event or message type returned by the API.</ResponseField>
<ResponseField name="bytes" type="integer">USD decimal string for billing reconciliation.</ResponseField>
