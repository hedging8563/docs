...
AI Sonar treats `/v1/files` as three explicit modes:
...
- The returned `file_id` is scoped to the API key that created it and can be reused in `/v1/messages` requests.
