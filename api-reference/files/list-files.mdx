...
Without Anthropic headers, the list can include both batch files and AI Sonar image/reference files. Use `purpose=batch`, `purpose=batch_output`, `purpose=user_data`, or `purpose=vision` to narrow the list.
