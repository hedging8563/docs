---
title: "WorkBuddy"
description: "Add AI Sonar as a custom model provider in WorkBuddy"
---
...
| Field | Value |
|---|---|
| Endpoint URL | `https://api.aisonar.dev/v1` |
...
For the `kimi-k3` example, use AI Sonar's current public capability metadata:
