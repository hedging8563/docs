---
title: "Open WebUI"
description: "Use AI Sonar as an OpenAI-compatible API connection in Open WebUI"
---

## Overview

Open WebUI supports custom OpenAI-compatible API connections. Add AI Sonar as a remote OpenAI-compatible endpoint and refresh the model list.
...
3. Set the base URL to `https://api.aisonar.dev/v1`.
4. Set the API key to your AI Sonar key.
