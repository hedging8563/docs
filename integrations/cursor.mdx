---
title: "Cursor"
description: "Use AI Sonar with Cursor AI code editor"
---
...
[Cursor](https://cursor.sh) supports bring-your-own-key (BYOK) providers, but custom API keys only work with standard chat models. Use AI Sonar here as an OpenAI-compatible endpoint for chat-style editor workflows, not as a full replacement for every Cursor model feature.
...
After configuration, prefer standard chat models exposed through AI Sonar:
...
Use AI Sonar through Cursor for:
...
These features do not reliably switch to your AI Sonar endpoint:
...
<AccordionGroup>
  ...
  <Accordion title="Another provider stopped working after enabling AI Sonar">
...
<CardGroup cols={2}>
  ...
  <Card title="Check your balance" icon="wallet">
    Monitor usage in your AI Sonar dashboard.
  </Card>
</CardGroup>
