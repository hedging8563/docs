---
title: "LlamaIndex"
description: "Integrate AI Sonar with LlamaIndex using OpenAI-compatible integrations"
---
...
For AI Sonar, the more robust LlamaIndex setup is to use **OpenAI-compatible integrations** instead of the built-in OpenAI classes.
...
<AccordionGroup>
  <Accordion title="Use OpenAILike for AI Sonar">
