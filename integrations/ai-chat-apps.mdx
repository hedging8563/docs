...
description: "Configure popular AI chat applications to use AI Sonar's OpenAI-compatible API"
---

## Overview

Most general AI chat apps connect to AI Sonar through the standard OpenAI-compatible chat path.
...
<Tabs>
  ...
  <Tab title="Jan">
    ...
    3. Enter:
       ...
       - **Base URL**: `https://api.aisonar.dev/v1`
       - **API Key**: `sk-your-api-key`
    4. Select `gpt-5.4-mini` or another AI Sonar model
  </Tab>
