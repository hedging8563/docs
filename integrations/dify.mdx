...
1. Log into [AI Sonar Dashboard](https://console.aisonar.dev/customer)
2. Open [API Keys](https://console.aisonar.dev/customer/api)
...
| Fast/cheap | `gpt-5-mini`, `gemini-3.5-flash` |
...
<AccordionGroup>
  ...
  <Accordion title="Use cheaper models for iteration">
    Use `gpt-5-mini` or `gemini-3.5-flash` while iterating, then switch heavier workflows to stronger models only where needed.
  </Accordion>
